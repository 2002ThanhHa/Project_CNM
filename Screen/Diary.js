...
const srticles=[
  ...
  {
    img_avata: require('../Image/boy.jpg'),
    name: 'Sury',
  ...
  return (
    <View style={{flex: 1, backgroundColor:'white', }}>
      ...
      <View /*Center*/ >
              ...
              renderItem={({item})=>{
                return(
                  <View style={{marginTop: 30, marginLeft: 20}}>
                    <View>
                      <View style={{flexDirection:'row'}}>
                        <Image source={require('../Image/girl.png')} style={{width: 65, height: 65, borderRadius: 50}}></Image>
                        <View style={{flexDirection:'row'}}>
                          <View>
                    ...
                    <Image source={item.img} style={{ height: 160, marginTop:15,marginLeft: -20}}/> 
                    <View style={{flexDirection:'row'}}>
                      <View>
        ...
        <View /*Footder*/ style={{flexDirection:'row', marginTop: 50, marginLeft: 20}}>
          <View >
          ...
          <View style={{marginLeft: 15}}>
            ...
            <Text style={{fontSize: 15, color:'#0C71E8'}}>Nhật ký</Text>
          </View>
